...
const getRoomExpirationHours = () => config.room.expirationHours;
const getRoomWarningMs = () => config.room.warningMinutes * 60 * 1000;
const getMaxParticipants = () => config.room.maxParticipants;

module.exports = {
  config,
  getRoomExpirationHours,
  getRoomWarningMs,
  getMaxParticipants,
};